...
# -----------------------------------------------------------------
    ...
    for _, row in pst.observation_data.iterrows():
        ...
        if oname == 'flux-diff':
            ...
            pst.observation_data.at[row.name, 'standard_deviation'] = AWq.loc[(kper, kstp, i, j), 'std']*4
            if pst.observation_data.at[row.name, 'standard_deviation'] > 0:
                pst.observation_data.at[row.name, 'weight'] = 1/(AWq.loc[(kper, kstp, i, j), 'std']*4)
            ...
            pst.observation_data.at[row.name, 'standard_deviation'] = SPq.loc[(kper, kstp, i, j), 'std']*4
            if pst.observation_data.at[row.name, 'standard_deviation'] > 0:
                pst.observation_data.at[row.name, 'weight'] = 1/(SPq.loc[(kper, kstp, i, j), 'std']*4)
            ...
            if (col in ['sw']): 
                ...
                pst.observation_data.at[row.name, 'obsval'] = budget.loc[kper, col]
                pst.observation_data.at[row.name, 'standard_deviation'] = budget.loc[kper, 'rch_std']*2
                if pst.observation_data.at[row.name, 'standard_deviation'] > 0:
                    pst.observation_data.at[row.name, 'weight'] = 1/(budget.loc[kper, 'rch_std']*2)
            ...
            pst.observation_data.at[row.name, 'standard_deviation'] = recession_truth.loc[kper, 'std']*2
            if pst.observation_data.at[row.name, 'standard_deviation'] > 0:
                pst.observation_data.at[row.name, 'weight'] = 1/(recession_truth.loc[kper, 'std']*2)
